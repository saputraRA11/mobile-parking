...
//                Spacer(modifier = Modifier.width(16.dp))
        ...
        Column(
            ...
            TextField(
                ...
                onValueChange = { if(it.text.isDigitsOnly()) {addAreaForm.value.biayaMobil.value = it} },
            ...
            TextField(
                ...
                onValueChange = { if(it.text.isDigitsOnly()) {addAreaForm.value.biayaMotor.value = it} },
