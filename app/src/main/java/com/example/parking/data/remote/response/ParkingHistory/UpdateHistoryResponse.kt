...
data class UpdateHistoryResponse(
	...
	val data: DataUpdateHistory? = null,

	@field:SerializedName("success")
	val success: Boolean? = null
)

data class TransactionHistoryUpdate(
...
data class DataUpdateHistory(

	@field:SerializedName("transaction_history")
	val transactionHistory: TransactionHistoryUpdate? = null,

	@field:SerializedName("parking_history")
	val parkingHistory: ParkingHistoryUpdate? = null
)

data class ParkingHistoryUpdate(
